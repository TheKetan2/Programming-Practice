...
let contactLenses = [{
    ...
    basecurves: ['', '8.60'],
    diameters: ['', '14.20'],
    sphere: ['+6.00', '+5.75', '+5.50', '+5.25', '+5.00', '+4.75', '+4.50', '+4.25',
        ...
        '-4.50', '-4.75', '-5.00', '-5.25', '-5.50', '-5.75', '-6.00', '-6.25', '-6.50', '-6.75', '-7.00', '-7.25', '-7.50', '-7.75', '-8.00',
...
},
{
    ...
    sphere: ['+8.00','+7.50','+7.00','+6.50','+6.00','+5.75','+5.50','+5.25','+5.00','+4.75','+4.50','+4.25',
    '+4.00','+3.75','+3.50','+3.25','+3.00','+2.75','+2.50','+2.25','+2.00','+1.75','+1.50','+1.25','+1.00','+0.75','+0.50','+0.25','','0.00','-0.25',
    '-0.50','-0.75','-1.00','-1.25','-1.50','-1.75','-2.00','-2.25','-2.50','-2.75','-3.00','-3.25','-3.50','-3.75','-4.00','-4.25',
    '-4.50','-4.75','-5.00','-5.25','-5.50','-5.75','-6.00','-6.25','-6.50','-6.75','-7.00','-7.25','-7.50','-7.75','-8.00',
...
},
{
    ...
    sphere: ['+6.00','+5.75','+5.50','+5.25','+5.00','+4.75','+4.50','+4.25','+4.00','+3.75','+3.50','+3.25','+3.00','+2.75',
    '+2.50','+2.25','+2.00','+1.75','+1.50','+1.25','+1.00','+0.75','+0.50','+0.25','','0.00','-0.25','-0.50','-0.75','-1.00','-1.25',
    ...
    axis: [],
    add: [],
    colors: ['','Amethyst', 'Blue', 'Brilliant Blue', 'Brown', 'Gemstone Green', 'Gray', 'Honey', 'Pure Hazel', 'Sterling Gray', 'True Sapphire', 'Turquoise'],
    cost: '55.00',
    type: 'colors'
},
{
    ...
    sphere: ['+4.00','+3.75','+3.50','+3.25','+3.00','+2.75',
    '+2.50','+2.25','+2.00','+1.75','+1.50','+1.25','+1.00','+0.75','+0.50','+0.25','','0.00','-0.25','-0.50','-0.75','-1.00','-1.25',
    '-1.50','-1.75','-2.00','-2.25','-2.50','-2.75','-3.00','-3.25','-3.50','-3.75','-4.00','-4.25','-4.50','-4.75','-5.00','-5.25',
    '-5.50','-5.75','-6.00','-6.50','-7.00','-7.50','-8.00','-8.50','-9.00'
    ],
    cylinder: ['','-.75', '-1.25', '-1.75', '-2.25'],
    axis: ['10', '20', '60', '70', '80', '90','', '100', '110', '110', '120', '160', '170', '180'],
    add: [],
    colors: [],
    cost: '67.00',
    type: 'toric'
